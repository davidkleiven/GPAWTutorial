...
from atomtools.ase import SaveRestartFiles, UpdateDBInfo, delete_vacancies
...
def main( argv ):
    ...
    db_paths = ["/home/ntnu/davidkl/GPAWTutorial/CE/almg_fcc_vac.db", "almg_fcc_vac.db","/home/davidkl/GPAWTutorial/CE/almg_fcc_vac.db"]
